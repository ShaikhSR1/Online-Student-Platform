package com.cse27.onlinestudentplatform.Adapter;
        ...
        //import com.bumptech.glide.Glide;
        import com.cse27.onlinestudentplatform.Model.PostModel;
...
public class AdapterPost extends RecyclerView.Adapter<AdapterPost.MyHolder> {
    ...
    public AdapterPost(Context context, List<PostModel> postModel) {
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, final int position) {
        final String uid = postModel.get(position).getUid();
        String nameh = postModel.get(position).getUname();
        final String titlee = postModel.get(position).getTitle();
        final String descri = postModel.get(position).getDescription();
        final String ptime = postModel.get(position).getPtime();
        String dp = postModel.get(position).getUdp();
        String plike = postModel.get(position).getPlike();
        final String image = postModel.get(position).getUimage();
        String email = postModel.get(position).getUemail();
        String comm = postModel.get(position).getPcomments();
        final String pid = postModel.get(position).getPtime();
        ...
        holder.likebtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final int plike = Integer.parseInt(postModel.get(position).getPlike());
                mprocesslike = true;
                final String postid = postModel.get(position).getPtime();
